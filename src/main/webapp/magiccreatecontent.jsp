 ...
 %>
	...
	$(document).ready(function() {
	    $("#uploadForm").submit(function(e) {
	        ...
	        $.ajax({
	            url: "magiccreatecontentAction.jsp", // 이미지와 게시물을 처리할 서버 스크립트 페이지
	            type: "POST",
	            data: formData,
	            processData: false,
	            contentType: false,
	            success: function(response) {
	                ...
	                window.location.href = "mycontentmagic.jsp";
	            },
	...
	<form method="post" id="uploadForm" action="magiccreatecontentAction.jsp" enctype="multipart/form-data">
