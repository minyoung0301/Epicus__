...
<%
	...
	if (session.getAttribute("userID") != null) {
	    ...
	    try {
	        ...
	        String sql = "SELECT freeID, image_path,fTitle,fInto,fDate,fAvailable, fopen,flike_count FROM free WHERE userID = ?";
...
<header class = "menubar">
 ...
 %>
	...
	<section class="contentsection">
		<span class="freebtn"><img src="pen.png" class="freepen"><input type="button" class="free" value="자유"></span>
	...
	<ul class="ullist">
		...
		<div class="image"><a href="mycontentlist.jsp?freeID=<%=freeID%>"><img src="<%=request.getContextPath()%><%=relativeImagePath %>"></a></div>
		<div class="contentdiv"><%=fTitle %></div>
